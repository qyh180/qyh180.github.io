           ...
           imageY = imageSize.split('.')[1];
            li += '<div class="card" style="width:330px">' +
                    '<div class="ImageInCard" style="height:'+ 330 * imageY / imageX + 'px">' +
                      '<a data-fancybox="gallery" href="https://github.com/qyh180/figure/blob/master/img/' + imgName + '">' +
                        '<img src="https://github.com/qyh180/figure/blob/master/img/' + imgName + '?raw=true"/>' +
                      '</a>' +
                    '</div>' +
